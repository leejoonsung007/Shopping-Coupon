...
public class CouponSerialize extends JsonSerializer<Coupon> {
    ...
    public void serialize(Coupon coupon, JsonGenerator generator, SerializerProvider serializers) throws IOException {
        ...
        generator.writeStringField("couponCode", coupon.getCouponCode().toString());
        generator.writeStringField("assignTime", new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
        ...
        generator.writeStringField("description", coupon.getTemplateSDK().getDescription());
